...
namespace E_commerce.Server.Migrations
{
    ...
    [Migration("20240418085028_Seeding")]
            ...
            modelBuilder.Entity("E_commerce.Shared.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            DateCreated = new DateTime(2024, 4, 18, 9, 50, 27, 922, DateTimeKind.Local).AddTicks(4110),
                        ...
                        new
                        {
                            Id = 2,
                            CategoryId = 3,
                            DateCreated = new DateTime(2024, 4, 18, 9, 50, 27, 922, DateTimeKind.Local).AddTicks(4127),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 3,
                            CategoryId = 1,
                            DateCreated = new DateTime(2024, 4, 18, 9, 50, 27, 922, DateTimeKind.Local).AddTicks(4129),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 4,
                            CategoryId = 2,
                            DateCreated = new DateTime(2024, 4, 18, 9, 50, 27, 922, DateTimeKind.Local).AddTicks(4131),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 8,
                            CategoryId = 3,
                            DateCreated = new DateTime(2024, 4, 18, 9, 50, 27, 922, DateTimeKind.Local).AddTicks(4133),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 9,
                            CategoryId = 3,
                            DateCreated = new DateTime(2024, 4, 18, 9, 50, 27, 922, DateTimeKind.Local).AddTicks(4134),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
